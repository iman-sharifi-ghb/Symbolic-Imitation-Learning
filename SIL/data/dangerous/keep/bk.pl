...
back_right_velocity_is_lower(s4).

back_velocity_is_bigger(s4).
% scenario no. 5:
front_is_busy(s5).
...
front_right_velocity_is_equal(s5).
...
front_left_velocity_is_lower(s10).
...
back_right_velocity_is_bigger(s32).
...
back_left_velocity_is_equal(s38).
...
back_right_velocity_is_lower(s47).
...
back_left_velocity_is_lower(s71).
...
back_left_velocity_is_lower(s74).
back_right_velocity_is_bigger(s74).

back_velocity_is_lower(s74).
% scenario no. 75:
front_is_busy(s75).
...
back_right_velocity_is_lower(s84).

back_velocity_is_equal(s84).
% scenario no. 85:
front_is_busy(s85).
...
back_left_velocity_is_lower(s89).
...
back_right_velocity_is_equal(s91).

back_velocity_is_equal(s91).
% scenario no. 92:
front_is_busy(s92).
...
back_distance_is_critical(s104).
...
back_left_velocity_is_lower(s109).
...
back_left_velocity_is_equal(s111).
...
back_distance_is_critical(s113).
...
front_left_velocity_is_equal(s118).
...
back_distance_is_critical(s119).
...
back_distance_is_critical(s131).
...
back_distance_is_critical(s136).
...
front_left_velocity_is_lower(s137).
...
back_right_velocity_is_lower(s140).

back_velocity_is_bigger(s140).
% scenario no. 141:
front_is_free(s141).
...
back_left_velocity_is_lower(s167).
back_right_velocity_is_bigger(s167).

back_velocity_is_bigger(s167).
% scenario no. 168:
front_is_free(s168).
...
back_right_velocity_is_equal(s177).

back_velocity_is_bigger(s177).
% scenario no. 178:
front_is_free(s178).
...
back_left_velocity_is_equal(s184).
back_right_velocity_is_equal(s184).

back_velocity_is_bigger(s184).
% scenario no. 185:
front_is_free(s185).
...
back_left_velocity_is_lower(s192).
back_right_velocity_is_equal(s192).

back_velocity_is_equal(s192).
% scenario no. 193:
front_is_free(s193).
...
front_left_velocity_is_lower(s195).
...
back_left_velocity_is_lower(s202).
...
back_distance_is_critical(s225).
...
front_right_velocity_is_lower(s227).
...
back_left_velocity_is_equal(s229).
...
front_right_velocity_is_lower(s253).
...
back_right_velocity_is_lower(s292).
...
back_left_velocity_is_lower(s312).
...
front_velocity_is_lower(s320).
front_left_velocity_is_lower(s320).
...
back_distance_is_critical(s322).
...
front_right_velocity_is_lower(s323).
...
back_left_velocity_is_lower(s369).
...
back_right_velocity_is_equal(s379).
...
front_left_velocity_is_lower(s387).
...
front_right_velocity_is_lower(s398).
...
back_distance_is_critical(s418).
...
back_distance_is_critical(s420).
...
front_velocity_is_lower(s431).
front_left_velocity_is_bigger(s431).
front_right_velocity_is_lower(s431).
...
back_distance_is_critical(s451).
...
back_right_velocity_is_equal(s458).

back_velocity_is_bigger(s458).
% scenario no. 459:
front_is_free(s459).
...
back_left_velocity_is_equal(s459).
...
back_left_velocity_is_equal(s467).
...
front_left_velocity_is_lower(s476).
...
front_left_velocity_is_equal(s478).
...
back_right_velocity_is_lower(s481).

back_velocity_is_bigger(s481).
% scenario no. 482:
front_is_free(s482).
...
back_left_velocity_is_lower(s496).
back_right_velocity_is_bigger(s496).

back_velocity_is_equal(s496).
% scenario no. 497:
front_is_free(s497).
...
front_right_velocity_is_equal(s518).
...
back_right_velocity_is_lower(s523).
...
front_right_velocity_is_lower(s544).
...
back_distance_is_critical(s547).
...
front_right_velocity_is_lower(s549).
back_left_velocity_is_equal(s549).
...
back_right_velocity_is_lower(s568).
...
back_distance_is_critical(s597).
...
back_right_velocity_is_equal(s606).
...
front_left_velocity_is_lower(s612).
...
back_right_velocity_is_lower(s627).
...
front_right_velocity_is_equal(s630).
...
back_right_velocity_is_lower(s631).
...
back_right_velocity_is_lower(s642).
...
front_right_velocity_is_lower(s652).
...
back_right_velocity_is_lower(s654).
...
back_distance_is_critical(s658).
...
back_left_velocity_is_equal(s681).
back_right_velocity_is_bigger(s681).

back_velocity_is_bigger(s681).
% scenario no. 682:
front_is_free(s682).
...
front_right_velocity_is_lower(s682).
...
front_right_velocity_is_lower(s693).
...
back_distance_is_critical(s723).
...
front_left_velocity_is_equal(s725).
...
front_left_velocity_is_equal(s740).
...
front_left_velocity_is_lower(s747).
...
back_distance_is_critical(s760).
...
back_right_velocity_is_lower(s769).
...
back_distance_is_critical(s770).
...
back_right_velocity_is_lower(s771).
...
front_left_velocity_is_lower(s773).
...
front_right_velocity_is_lower(s774).
...
back_right_velocity_is_lower(s786).

back_velocity_is_lower(s786).
% scenario no. 787:
front_is_busy(s787).
...
back_distance_is_critical(s788).
...
back_right_velocity_is_equal(s791).
...
back_right_velocity_is_equal(s799).

back_velocity_is_lower(s799).
% scenario no. 800:
front_is_busy(s800).
...
front_right_velocity_is_lower(s810).
...
front_left_velocity_is_lower(s815).
...
front_left_velocity_is_lower(s820).
...
back_distance_is_critical(s822).
...
back_distance_is_critical(s834).
...
back_distance_is_critical(s840).
...
front_left_velocity_is_lower(s844).
...
back_right_velocity_is_lower(s849).

back_velocity_is_lower(s849).
% scenario no. 850:
front_is_busy(s850).
...
back_left_velocity_is_lower(s857).
...
back_right_velocity_is_lower(s870).

back_velocity_is_bigger(s870).
% scenario no. 871:
front_is_busy(s871).
...
back_distance_is_critical(s882).
...
front_left_velocity_is_equal(s884).
...
back_right_velocity_is_lower(s890).
...
front_left_velocity_is_equal(s891).
...
front_left_velocity_is_lower(s903).
...
front_left_velocity_is_lower(s905).
...
back_right_velocity_is_lower(s910).

back_velocity_is_lower(s910).
% scenario no. 911:
front_is_free(s911).
...
back_distance_is_critical(s915).
front_velocity_is_equal(s915).
front_left_velocity_is_lower(s915).
...
front_right_velocity_is_lower(s917).
...
front_left_velocity_is_lower(s918).
...
back_distance_is_critical(s929).
...
front_right_velocity_is_lower(s935).
...
back_right_velocity_is_lower(s947).

back_velocity_is_equal(s947).
% scenario no. 948:
front_is_free(s948).
...
back_left_velocity_is_lower(s952).
...
back_left_velocity_is_lower(s962).
...
back_distance_is_critical(s963).
...
front_left_velocity_is_lower(s971).
...
back_distance_is_critical(s999).

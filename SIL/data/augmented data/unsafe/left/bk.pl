...
:- dynamic front_is_busy/1.
:- dynamic front_right_is_busy/1.
:- dynamic front_right_is_busy/1.
:- dynamic right_is_busy/1.
:- dynamic back_right_is_busy/1.
:- dynamic back_is_busy/1.
:- dynamic back_left_is_busy/1.
:- dynamic left_is_busy/1.
:- dynamic front_left_is_busy/1.
:- dynamic front_is_free/1.
:- dynamic front_right_is_free/1.
:- dynamic front_right_is_free/1.
:- dynamic right_is_free/1.
:- dynamic back_right_is_free/1.
:- dynamic back_is_free/1.
:- dynamic back_left_is_free/1.
:- dynamic left_is_free/1.
:- dynamic front_left_is_free/1.
:- dynamic right_is_invalid/1.
:- dynamic right_is_valid/1.
:- dynamic left_is_invalid/1.
:- dynamic left_is_valid/1.
:- dynamic ego_velocity_is_legal/1.
:- dynamic ego_velocity_is_illegal/1.
:- dynamic front_distance_is_safe/1.
:- dynamic front_distance_is_critical/1.
:- dynamic front_velocity_is_bigger/1.
:- dynamic front_left_velocity_is_bigger/1.
:- dynamic front_right_velocity_is_bigger/1.
:- dynamic back_left_velocity_is_bigger/1.
:- dynamic back_right_velocity_is_bigger/1.
:- dynamic front_velocity_is_equal/1.
:- dynamic front_left_velocity_is_equal/1.
:- dynamic front_right_velocity_is_equal/1.
:- dynamic back_left_velocity_is_equal/1.
:- dynamic back_right_velocity_is_equal/1.
:- dynamic front_velocity_is_lower/1.
:- dynamic front_left_velocity_is_lower/1.
:- dynamic front_right_velocity_is_lower/1.
:- dynamic back_left_velocity_is_lower/1.
:- dynamic back_right_velocity_is_lower/1.
...
back_right_velocity_is_equal(s7).
...
front_right_velocity_is_equal(s8).
back_left_velocity_is_equal(s8).
...
front_distance_is_critical(s14).
...
front_right_velocity_is_bigger(s26).
...
back_left_velocity_is_bigger(s27).
...
front_left_velocity_is_equal(s39).
...
back_right_velocity_is_equal(s42).
...
back_left_velocity_is_equal(s57).
...
back_left_velocity_is_bigger(s91).
...
front_right_velocity_is_equal(s94).
...
front_right_velocity_is_equal(s113).
...
front_left_velocity_is_equal(s125).
...
front_right_velocity_is_equal(s129).
...
front_left_velocity_is_equal(s152).
...
front_right_velocity_is_equal(s156).
back_left_velocity_is_equal(s156).
...
back_left_velocity_is_equal(s159).
...
front_left_velocity_is_bigger(s162).
...
front_left_velocity_is_equal(s170).
...
front_left_velocity_is_bigger(s176).
...
back_right_velocity_is_equal(s203).
...
front_left_velocity_is_bigger(s206).
...
front_left_velocity_is_bigger(s213).
...
front_left_velocity_is_equal(s229).
...
back_left_velocity_is_equal(s237).
...
back_right_velocity_is_bigger(s265).
...
front_left_velocity_is_bigger(s267).
...
front_left_velocity_is_bigger(s269).
...
front_left_velocity_is_bigger(s271).
...
front_right_velocity_is_equal(s273).
...
front_velocity_is_equal(s278).
front_left_velocity_is_equal(s278).
...
back_left_velocity_is_equal(s292).
...
back_right_velocity_is_bigger(s312).
...
back_left_velocity_is_equal(s351).
...
back_left_velocity_is_equal(s356).
...
front_left_velocity_is_equal(s358).
...
front_right_velocity_is_equal(s372).
...
back_right_velocity_is_bigger(s373).
...
back_left_velocity_is_bigger(s376).
...
back_right_velocity_is_equal(s380).
...
back_left_velocity_is_equal(s393).
...
back_left_velocity_is_equal(s399).
...
back_right_velocity_is_equal(s406).
...
back_right_velocity_is_equal(s408).
...
back_left_velocity_is_bigger(s412).
...
back_right_velocity_is_equal(s424).
...
front_left_velocity_is_bigger(s455).
front_right_velocity_is_equal(s455).
back_left_velocity_is_equal(s455).
...
front_right_velocity_is_equal(s463).
...
front_left_velocity_is_bigger(s483).
...
front_left_velocity_is_equal(s486).
...
back_left_velocity_is_bigger(s489).
...
front_left_velocity_is_bigger(s498).
...
back_right_velocity_is_equal(s501).
...
back_left_velocity_is_equal(s506).
...
front_right_velocity_is_equal(s508).
...
front_left_velocity_is_equal(s510).
...
front_left_velocity_is_equal(s529).
...
front_left_velocity_is_bigger(s544).
front_right_velocity_is_equal(s544).
back_left_velocity_is_equal(s544).
back_right_velocity_is_bigger(s544).
...
front_right_velocity_is_equal(s558).
back_left_velocity_is_equal(s558).
...
front_right_velocity_is_equal(s568).
...
back_right_velocity_is_equal(s573).
...
front_right_velocity_is_bigger(s576).
...
back_left_velocity_is_equal(s578).
...
front_left_velocity_is_bigger(s603).
...
back_right_velocity_is_equal(s610).
...
front_velocity_is_equal(s618).
front_left_velocity_is_bigger(s618).
...
back_left_velocity_is_bigger(s633).
...
front_left_velocity_is_equal(s636).
...
front_right_velocity_is_bigger(s666).
...
back_right_velocity_is_equal(s682).
...
front_left_velocity_is_bigger(s707).
front_right_velocity_is_equal(s707).
...
back_left_velocity_is_equal(s717).
...
front_left_velocity_is_equal(s718).
...
back_left_velocity_is_bigger(s722).
...
front_left_velocity_is_bigger(s727).
...
front_right_velocity_is_bigger(s730).
...
back_left_velocity_is_bigger(s738).
...
front_left_velocity_is_bigger(s746).
...
front_left_velocity_is_bigger(s756).
...
front_right_velocity_is_equal(s763).
...
back_right_velocity_is_equal(s775).
...
back_left_velocity_is_equal(s780).
...
back_right_velocity_is_bigger(s783).
...
front_right_velocity_is_bigger(s793).
...
front_right_velocity_is_equal(s825).
...
back_right_velocity_is_equal(s847).
...
front_velocity_is_equal(s880).
front_left_velocity_is_equal(s880).
...
back_left_velocity_is_equal(s894).
...
front_left_velocity_is_bigger(s898).
...
back_left_velocity_is_equal(s908).
...
front_left_velocity_is_bigger(s910).
...
front_right_velocity_is_equal(s914).
...
back_right_velocity_is_equal(s925).
...
front_left_velocity_is_equal(s940).
...
front_left_velocity_is_bigger(s944).
...
front_right_velocity_is_bigger(s955).
...
front_velocity_is_equal(s956).
front_left_velocity_is_bigger(s956).
...
front_left_velocity_is_equal(s971).
front_right_velocity_is_bigger(s971).
back_left_velocity_is_bigger(s971).
...
back_right_velocity_is_equal(s976).
...
front_right_velocity_is_equal(s984).
...
front_right_velocity_is_bigger(s994).
...
front_left_velocity_is_equal(s1002).
...
front_left_velocity_is_equal(s1003).
...
front_left_velocity_is_equal(s1013).
...
front_left_velocity_is_bigger(s1017).
